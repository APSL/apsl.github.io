...
describe('GithubClient repo comparator', () => {
  ...
  it('should return 1 when both repos has same stars and watchers and repo1 has more forks than repo2', () => {
  ...
  it('should return -1 when both repos has same stars and watchers and repo1 has less forks than repo2', () => {
